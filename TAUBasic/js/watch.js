//WATCH
(function() {
	var timerUpdateDate = 0, flagConsole = false, flagDigital = false, battery = navigator.battery
			|| navigator.webkitBattery || navigator.mozBattery, interval, arrDay = [
			"Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat" ], arrMonth = [
	...
	function updateTime() {
		var strHours = document.getElementById("str-hours"), strConsole = document
				...
				.getElementById("str-minutes"), strAmpm = document
				.getElementById("str-ampm"), datetime = tizen.time
	...
	function initDigitalWatch() {
		flagDigital = true;
		// document.getElementById("digital-body").style.backgroundImage =
		// BACKGROUND_URL;
	...
	function getBatteryState() {
		var batteryLevel = Math.floor(battery.level * 10), batteryFill = document
